    ...
    .then(function () {
      return Promise.all([
        ...
        knex('projects').insert({
          ...
          date: 'May 2018',
          live_link: '',
          thumbnail: 'https://storage.cloud.google.com/alan_portfolio/Thumbs/svgrenderer2.svg',
        }),
        knex('projects').insert({
          id: 5,
        ...
        knex('projects').insert({
          ...
          description: 'This is the very first javascript project that I ever built. It is integrated with the Wikipedia API, to pull the user\'s past five lives on this Earth. All that is required is a birthdate and some black magic, and the app is able to look generate not only the users past five lives, but also the misadventures that occur in between them.',
          type: 'javascript',
          role: 'Front End Developer',
          date: 'March 2016',
