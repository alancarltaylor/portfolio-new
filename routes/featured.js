...
router.get('/app/featured', (req, res, next) => {
...
router.get('/app/featured/:id', (req, res, next) => {
...
router.post('/app/featured', (req, res, next) => {
...
router.patch('/app/featured/:id', (req, res, next) => {
  const id = req.params.id;
...
router.delete('/app/featured/:id', (req, res, next) => {
  const id = req.params.id;
  knex('projects')
    .where('id', id)
    .del(('*'))
